      ...
      <animated.div style={animProps}>
        <div className='mx-auto  px-12 container'>
          ...
          <p className='mt-4 leading-7  '>
            ...
            çeşitliliğimiz ile dünyanın her yerindeki kadınların vazgeçilmez
            cilt bakım markalarından biri olmayı başardık.
          </p>
          <p className='mt-4 leading-7 '>
            AR-GE süreci ile başlayan serüvenimiz, tüketiciye ürünü
            ulaştırmamız, ardından sunduğumuz müşteri memnuniyeti odaklı satış
            sonrası hizmetlerimiz ve kuruluşumuzdan bu yana yaptığımız inovatif,
          ...
          <p className='mt-4 leading-7'>
            2016 yılından itibaren Hollanda merkezimiz Amsterdam üzerinden
            birçok Avrupa ülkesindeki müşterilerimizle online kanallar aracılığı
            ile buluşmaya başladık.
          </p>
          <p className='mt-4 leading-7'>
            2022 yılında Hollanda’da ve Irak’ta mağazalar açarak bu ülkelerde
            daha geniş tüketiciye ulaşmayı başardık.
          </p>
          <p className='mt-4 leading-7'>
            İnsan sağlığına ve çevreye olan duyarlılığımızı en ön planda tutarak
            ürünlerimizin %98’ini geri dönüştürülebilir ambalajlardan
            üretiyoruz. Dünyanın en büyük hayvan hakları organizasyonu PETA
            tarafından onaylı bir marka olmaktan gurur duyuyoruz! Ürün
            çeşitliliğimizde vegan ürünlere yer veriyor ve ürünlerimizde hayvan
            deneyleri yapmayı reddediyoruz.
          </p>
          <p className='mt-4 leading-7'>
